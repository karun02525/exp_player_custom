...
class VideoPlayerActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private var screen = 0 //0-landscap 1-portrait
...
imgRotate.setOnClickListener(this)
    ...
    companion object {
        const val STREAM_URL = "https://media.chingari.io/apipublic/uploads/postMedia/863fc92f-20e8-4a5e-9fc6-856bdfd60c8d-1610723727970.mp4"
    }

    override fun onClick(v: View?) {
        if(v!!.id == imgRotate.id){
            if (screen == 0) {
                screen = 1
